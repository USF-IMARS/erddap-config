...
```xml
<dataset type="EDDGridFromNcFiles" datasetID="SST_66bb_c258_cd59" active="true">
    <reloadEveryNMinutes>90</reloadEveryNMinutes>
    <updateEveryNMillis>10000</updateEveryNMillis>
    <fileDir>/srv/imars-objects/fk/MEAN_7D_VSNPP/SST/</fileDir>
    ...
    <addAttributes>
        ...
        <att name="title">VIIRS SST</att>
    </addAttributes>
    <axisVariable>
        <sourceName>***fileName,timeFormat=yyyyDDD,VSNPP_(\d{7})_(\d{7})_7D_FK_SST\.nc,2</sourceName>

...
example filename : MODA_2020099_2020099_7D_FK_SST4.nc

-->
```

```xml
<dataset type="EDDGridFromNcFiles" datasetID="SST4_aac4_99a3_6549" active="true">
    <reloadEveryNMinutes>90</reloadEveryNMinutes>
    <updateEveryNMillis>10000</updateEveryNMillis>
    <fileDir>/srv/imars-objects/fk/MEAN_7D_MODA/SST4/</fileDir>
    ...
    <addAttributes>
        ...
        <att name="keywords">anomaly, data, earth, Earth Science &gt; Land Surface &gt; Land Temperature &gt; Land Surface Temperature, Earth Science &gt; Oceans &gt; Ocean Temperature &gt; Sea Surface Temperature, florida, land, local, ocean, oceans, science, sea, sea_surface_temperature, source, south, sst4_anom, sst4_median, surface, surface_temperature_anomaly, temperature, university, usf</att>
        ...
        <att name="title">MODIS Aqua 7d SST4.</att>
    </addAttributes>
    <axisVariable>
        <sourceName>***fileName,timeFormat=yyyyDDD,MODA_(\d{7})_(\d{7})_7D_FK_SST4\.nc,2</sourceName>
